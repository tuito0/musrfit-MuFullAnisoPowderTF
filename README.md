...
`MuFullAnisoPowderTF` is a plug-in user function for `musrfit` that calculates the transverse-field μSR polarization of powder-averaged muonium with a fully anisotropic hyperfine tensor,
