...
`MuFullAnisoPowderTF` is a plug-in user function for musrfit that calculates the transverse-field μSR polarization of powder-averaged muonium with a fully anisotropic hyperfine tensor with principal values [A_{xx}, A_{yy}, A_{zz}]
\]
